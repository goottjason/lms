...
@NoArgsConstructor
@AllArgsConstructor
public class PageClassroomRespDTO<T> {
  ...
  private List<T> classroomRepsDTOS;

  @Builder(builderMethodName = "withPageInfo")
  public PageClassroomRespDTO(
      PageClassroomReqDTO pageClassroomReqDTO,
      List<T> classroomRepsDTOS,
      int totalRecords
  ) {

    this.totalRecords = totalRecords;

    this.pageNo = pageClassroomReqDTO.getPageNo();
    this.pageSize = pageClassroomReqDTO.getPageSize();
    this.classroomRepsDTOS = classroomRepsDTOS;
