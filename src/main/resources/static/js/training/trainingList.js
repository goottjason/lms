  ...
  function parseDate(calendarDay) {
    ...
    let registerMonth = registerTitle.split("년")[1].split("월")[0].trim().padStart(2, "0");
    ...
    location.href = `/training/trainingRegister?registerDate=` + encodeURIComponent(registerDate);
